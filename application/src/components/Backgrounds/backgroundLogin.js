...
import CanvasFactory from "../../helpers/canvasFactory";
...
const Waves = () => {
    if (document.querySelector("#waves canvas")) return;

    new CanvasFactory(document.querySelector("#waves"), {
        texture:
...
export const BgLogin = () => {
    const bgLogin = <BackgroundLogin id="waves" />;
